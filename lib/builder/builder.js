...
function builder(defaultOptionMethod){
	...
	var b = {
		...
		method : function(verb, _fct){
			...
			if( !parents[0].methods['OPTIONS'] && defaultOptionMethod){
				parents[0].methods['OPTIONS'] = {fcts : (typeof defaultOptionMethod === 'function' ? [defaultOptionMethod] : defaultOptionMethod ) };
			}
			return this;
		},
		parent : function(){
